<template>
  <div>
    <b-carousel id="carousel-fade" style="text-shadow: 0px 0px 2px #000" fade indicators img-width="2" img-height="2">
      ...
      <b-carousel-slide caption="Imágen 1" img-src="https://picsum.photos/1024/480/?image=12"/>
      <b-carousel-slide caption="Imágen 1" img-src="https://picsum.photos/1024/480/?image=22"/>
    </b-carousel>
  </div>
</template>
